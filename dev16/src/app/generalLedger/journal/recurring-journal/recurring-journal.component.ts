...
@Component({
  selector: 'app-recurring-journal',
  templateUrl: './recurring-journal.component.html',
  styleUrls: ['./recurring-journal.component.css']
})
export class RecurringJournalComponent implements OnInit {
